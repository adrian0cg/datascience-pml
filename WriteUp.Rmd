...
## Prediction
### Data-Splitting
To asses our predictions and to also get a hold of computational complexity, we split our data into four equally sized groups, which we we later use for model assessment and 4-fold cross validation
```{r createDataPartition, echo=TRUE, cache=TRUE}
inValidation <- createFolds(pmlTraining$classe, k=4)
```
